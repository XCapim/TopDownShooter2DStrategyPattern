...
public class EnemyController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        zAnguloEuler.z = Mathf.Atan2(GameController.instancia.GetPlayerPosition().y-transform.position.y,GameController.instancia.GetPlayerPosition().x-transform.position.x) * Mathf.Rad2Deg -90f;
